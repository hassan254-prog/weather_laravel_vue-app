            ...
            <div class="col-8 col-lg-4 bg-dark text-light p-4 h-75 rounded shadow d-flex justify-content-between flex-column align-items-center" style="--mdb-bg-opacity: 0.7;">
                ...
                <div class="w-75 text-center">
                    <div class="form-outline">
                        <div class="text-start text-muted">Submit the city name</div>
                    ...
                    <button type="button" class="btn btn-outline-warning mt-3" data-mdb-ripple-color="warning" @click="search()">Search</button>
                </div>
                <div class="w-100 text-end">
                    <hr>
                    <span class="text-muted">Made with ❤️ by Hassan_Wari</span>
                </div>
            </div>
            <div class="col-2 col-lg-4"></div>
        </div>
